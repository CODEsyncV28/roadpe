...
const replaceWith = `        {/* STAGE 3: PROBLEM STATUS TRACKING (Pending -> In Progress -> Solved) */}
        {isTrackingTab && (
...
code = code.replace(targetEnd, replaceEndWith);
